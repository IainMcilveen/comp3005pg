...
req.params.query changes depending on what the user searched for on the page and will query for what they are seaching for. The query is being generated by the front end javascript from what they searched.
*/
